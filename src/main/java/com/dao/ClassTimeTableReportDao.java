...
public class ClassTimeTableReportDao {
	...
	public ResultSet getClassTimeTableByDay(String classroom, String day ,String[] slot,int counter)
	{
		int temp=0;
		ResultSet rs1;
		ResultSet rs2;
		...
		try {
			...
			pstat=con.prepareStatement("select *from timetable_generation where classroom=? and day=? and fromtime=? and totime=?");
			pstat.setString(1, classroom);
...
//		
	...
	public ResultSet getDuplicateRow(String classroom,String ft,String tt,String day)
	{
